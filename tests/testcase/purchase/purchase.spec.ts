...
test.describe("@E2E", () => {
  ...
  test("E2E-1: Flow of purchase item", async ({
    signinPage,
    homePage,
    basePage,
    productDetailPage,
    ...
    await test.step(`VP: order summary are correct`, async () => {
      ...
      Assertions.assertEqual(
        await shippingPage.getProductName(
          testData.firstProductInformation.productName
        ),
        testData.firstProductInformation.productName,
        "Product name are"
      ...
      Assertions.assertEqual(
        await shippingPage.getQuantity(
          testData.firstProductInformation.productName
        ),
        1,
        "Product quantity are"
      );
      Assertions.assertEqual(
        await shippingPage.getPrice(
          testData.firstProductInformation.productName
        ),
        firstJacketPrice,
        "Product price are"
